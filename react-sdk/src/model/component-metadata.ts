...
// Support for modern JSON Schema formats (Draft 2020-12) generated by Zod v4
interface ModernJSONSchema {
  $schema?: string;
  type?: string | string[];
...
> {
  ...
  toolSchema: z.ZodTypeAny | JSONSchemaLite;
}
...
export interface TamboComponent {
   ...
   * Supports both legacy JSONSchema7 and modern JSON Schema formats (including Zod v4 output).
   */
  propsSchema?: z.ZodTypeAny | JSONSchema7 | ModernJSONSchema;
  /**
